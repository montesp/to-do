  ...
  return (
    <div className="fixed top-0 right-0 w-full h-full flex justify-center items-center z-10 bg-black bg-opacity-60">
      <form
        ...
        className="relative flex flex-col bg-white  w-11/12 md:w-3/5 lg:w-2/5 xl:w-2/5 px-8 py-4 rounded-xl  "
      >
        <button>
          x
          <FaX className="absolute right-4 top-4 w-4 h-4 font-bold  hover:text-red-500" />
        </button>
        <label className="text-black text-center font-medium text-2xl mb-2">
          Create a todo
        </label>
        <input
        ...
        <div className="flex justify-around my-4 w-4/5 mx-auto ">
          ...
          <button
            type="submit"
            className=" text-black border-2 border-black px-4 py-2 rounded-lg hover:bg-black hover:text-white"
          >
            Create
          </button>
        </div>
